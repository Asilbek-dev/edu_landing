...
import './../css/university_name.css'
            ...
            <div className='container'>
                ...
                <div className='row m-0'>
                    <div className='col-12 col-md-6 col-lg-8'>
                        <div
                            className='uni_img_1'
                            style={{ backgroundImage: 'url("/images/bg_uni.png")' }}
                        >
                            <div className='uni_img_2'>
                                <img className='' src='/images/uni_2.png' alt='uni' />
                            </div>
                        </div>
                    </div>
                    <div className='col-12 col-md-6 col-lg-4'>
                        <div className='uni_container'>
                            <div className='uni_block'>
                                <table className='table striped'>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style={{ width: '40%' }}>Язык обучения</td>
                                            <td style={{ width: '60%' }}>Английский</td>
                                        </tr>
                                        <tr>
                                            <td style={{ width: '40%' }}>Год основания</td>
                                            <td style={{ width: '60%' }}>1990</td>
                                        </tr>
                                        <tr>
                                            <td style={{ width: '40%' }}>К-во студентов</td>
                                            <td style={{ width: '60%' }}>10 000</td>
                                        </tr>
                                        <tr>
                                            <td style={{ width: '40%' }}>
                                                Средняя цена за семестр
                                            </td>
                                            <td style={{ width: '60%' }}>10 000 грн</td>
                                        </tr>
                                        <tr>
                                            <td style={{ width: '40%' }}>
                                                Средняя цена за проживание
                                            </td>
                                            <td style={{ width: '60%' }}>10 000 грн</td>
                                        </tr>
                                    </tbody>
